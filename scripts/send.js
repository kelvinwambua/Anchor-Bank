...
import { generateTransactionTable, generateRandomTransactionId, addTransaction } from "../data/history.js";
...
function withdrawMoney() {
  if (selectedUsers.length === 0) {
    ...
    if (!isNaN(amount) && amount > 0 && userInfo.balance !== undefined && amount <= userInfo.balance) {
